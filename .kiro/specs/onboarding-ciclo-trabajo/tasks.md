...
- [x] 5. Implementar sistema básico de ciclos de trabajo

  - [x] 5.1 Crear CycleOrchestrator básico
  ...
  - [x] 5.2 Integrar ciclos con timer existente
  ...
  - [x] 5.3 Crear interfaz básica de ciclos
