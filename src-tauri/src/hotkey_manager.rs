...
mod tests {
    ...
    #[test]
    fn test_hotkey_action_default_shortcuts() {
        let command_palette = HotkeyAction::ToggleCommandPalette.default_shortcut();
        let focus_session = HotkeyAction::ToggleFocusSession.default_shortcut();
    ...
    fn test_hotkey_config_creation() {
        let config = HotkeyConfig::new(HotkeyAction::ToggleCommandPalette);
        assert_eq!(config.action, HotkeyAction::ToggleCommandPalette);
    ...
    fn test_hotkey_action_descriptions() {
        assert_eq!(
            HotkeyAction::ToggleCommandPalette.description(),
            "Toggle Command Palette"
        );
        assert_eq!(
            HotkeyAction::ToggleFocusSession.description(),
            "Toggle Focus Session"
        );
        assert_eq!(
            HotkeyAction::ImmediateLock.description(),
            "Immediate Lock/Break"
        );
    }
}
